...
const defaultMeta = {
  title: 'Two Left Feet Dance Studio - Newport News',
  siteName: 'Two Left Feet',
  description:
    'A place for folks with Two Left Feet to learn to dance socially, and have fun doing it!',
  url: 'https://twoleftfeetdancestudio.net',
  type: 'website',
  robots: 'follow, index',
  /**
